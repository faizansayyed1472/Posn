    ...
    >
      ...
      <div className="w-full border-t border-slate-200/80 dark:border-slate-800/80 pt-1.5">
        ...
        >
          ...
          >
            <Settings className={`w-4 h-4 flex-shrink-0 ${isOwner ? (themeMode === 'light' ? 'text-slate-600' : 'text-slate-300') : 'text-amber-500'}`} />
